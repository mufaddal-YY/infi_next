            ...
            <div className="col-md-6">
              <div className="">
                ...
                <p>
                  ...
                  <li>Use-case driven approach specific to target audience</li>
                  <li>
                    Outreach Campaigns for Universities, students, startup and
                    developer ecosystem
                  </li>
                </p>
              </div>
          ...
          <div className="row m-t30">
            ...
            <div className="col-md-6">
              <div className="">
                ...
                <hr />
                <p>
                  Developing innovative and unique learning content for Tech and
                  Non-Tech education backgrounds to improve Digital Proficiency,
                  Career Readiness, and Entrepreneurial Opportunities in the
                  Skilling Industry.
                  <li>
            ...
            <div className="col-md-6">
              <div className="">
                ...
                <p>
                  ...
                  through collaborative efforts with state governments and State
                  Skill Mission Offices.
                  <li>Diversity & Inclusion focused programs</li>
                  <li>Up-skilling students in Tier-3 & Tier-4 institutes</li>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row m-t30">
            ...
            <div className="col-md-6">
              <div className="">
                ...
                <hr />
                <p>
                  Incorporating industry vetted content and solutions to align
                  with university curriculum making students industry ready.
                ...
                <Link className="btn-secondry  radius-sm" href={"/unispark"}>
          ...
          <div className="row m-t30">
            ...
            <div className="col-md-6">
              <div className="">
                ...
                <hr />
                <p>
                  Facilitating comprehensive training programs based on the need
                  analysis for the different target groups to ensure optimal
                  results.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="">
                ...
                <p>
                  ...
                  various conventional and new-age marketing strategies to drive
                  registrations for campaign.
                  <li>Corporate Training</li>
                  <li>Faculty Development Workshops</li>
                  <li>Faculty and students training by certified trainers</li>
