...
const content = [
  
  {
    ...
    description: "With a strong emphasis on industry 4.0, we conduct the workshops specially designed to enhance the skills of participants. The workshop gets conducted both online and offline to cater to the needs of a diverse audience. The practical approach of the workshop will focus on hands-on experience and real-world examples, and provide participants with an understanding of the latest trends and technologies.",
    
  },
  {
    title: "Financial Literacy",
    description: "To help individuals develop an understanding of basic financial concepts and skills, our in-house designed curriculum is tailored to serve both rural and urban Indian audiences with a focus on the latest financial trends, to provide individuals with up-to-date information and knowledge about the financial landscape.",
...
const SliderThree = forwardRef((props, ref) => {
