          ...
          <Tab.Content>
                ...
                <div className="col-md-6">
                  <div className="">
                    ...
                    <p>
                      ...
                      innovative programs with comprehensive end-to-end program
                      management.
              ...
              <div className="row m-t30">
                ...
                <div className="col-md-6">
                  <div className="">
                    ...
                    <hr />
                    <p>
                      Developing innovative and unique learning content for Tech
                      and Non-Tech education backgrounds to improve Digital
                      Proficiency, Career Readiness, and Entrepreneurial
              ...
              <div className="row m-t30">
                ...
                <div className="col-md-6">
                  <div className="">
                    ...
                    <hr />
                    <p>
                      Enhancing skills and knowledge in underserved communities
                      through collaborative efforts with state governments and
                      State Skill Mission Offices.
            ...
            <Tab.Pane eventKey="tabCurriculum">
              <div className="row m-t30">
                ...
                <div className="col-md-6">
                  <div className="">
                    <h5 className="title text-blue">Curriculum Integration</h5>
                    <hr />
                    <p>
                      Incorporating industry vetted content and solutions to
                      align with university curriculum making students industry
                      ready.
              ...
              <div className="row m-t30">
                ...
                <div className="col-md-6">
                  <div className="">
                    ...
                    <hr />
                    <p>
                      Facilitating comprehensive training programs based on the
                      need analysis for the different target groups to ensure
                      optimal results.
                    </p>
                  </div>
                </div>
